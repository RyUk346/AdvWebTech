...
const Sidebar = () => {
  ...
  return (
    ...
    <div className={`drawer ${open ? "open" : ""}`}>
      ...
      <button
        className="top-3 right-1 bg-red-300 w-10 h-10 rounded-full drop-shadow-lg justify-center items-center text-white text-4xl hover:bg-teal-800   duration-300"
      ...
      <div
            className={`w-48 px-2 bg-blue-300 h-screen absolute top-0 left-0 transition-transform duration-500 transform ${
